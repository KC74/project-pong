...
// settings.js
var SVG_NS = exports.SVG_NS = 'http://www.w3.org/2000/svg'; // SVG Namespace
...
var Game = function () {
	...
	function Game(gameElement, width, height) {
		var _this = this;
		...
		// paddle one (left)
		this.paddle1 = new _Paddle2.default(this.height, PADDLE_WIDTH, PADDLE_HEIGHT, BOARD_GAP, (this.height - PADDLE_HEIGHT) / 2, _settings.KEYS.a, _settings.KEYS.z);

		// paddle one (right)
		this.paddle2 = new _Paddle2.default(this.height, PADDLE_WIDTH, PADDLE_HEIGHT, this.width - BOARD_GAP - PADDLE_WIDTH, (this.height - PADDLE_HEIGHT) / 2, _settings.KEYS.up, _settings.KEYS.down);

		// new ball
		this.ball = new _Ball2.default(BALL_RADIUS, this.width, this.height);

		// player 1 score
		this.paddle1Score = new _Score2.default(this.paddle1, this.width / 2 - 70 + 10, 30);

		// player 2 score
		this.paddle2Score = new _Score2.default(this.paddle2, this.width / 2 + 70 - 30, 30);
		...
		// LISTEN SMALL CHANGE
		(0, _jquery2.default)('#ball-size-small').on('click', function () {
			// CHANGE SETTINGS
			_this.setBallSize(3);
		});

		// LISTEN MEDIUM CHANGE
		(0, _jquery2.default)('#ball-size-medium').on('click', function () {
			// CHANGE SETTINGS
			_this.setBallSize(6);
		});

		// LISTEN LARGE CHANGE
		(0, _jquery2.default)('#ball-size-large').on('click', function () {
			// CHANGE SETTINGS
			_this.setBallSize(10);
		});

		// LISTEN RESET CHANGE
		(0, _jquery2.default)('#ball-size-reset').on('click', function () {
			// CHANGE SETTINGS
			_this.setBallSize(BALL_RADIUS);
		});
	...
	_createClass(Game, [{
		key: 'setBallSize',
		value: function setBallSize(ballSize) {
		...
		value: function render() {
			var BALL_SIZE_SUBMIT = document.getElementById('ball-size-submit');
			var BALL_SIZE_INPUT = document.getElementById('ball-size-input');
...
var game = new _Game2.default('game', 512, 256); // injecting styles from webpack
...
window.onload = function () {
    var ballElement = document.getElementById('ball-title');
    var ballListContainer = document.getElementById('ball-list-container');
    var ballSettingsChange = document.getElementById('ball-settings-change');
    var SIZE = document.getElementById('ball-size-btn');
    var SPEED = document.getElementById('ball-speed-btn');
    ...
    ballElement.onclick = function () {
        ...
        SIZE.onclick = function () {
            // TOGGLE FORM
            (0, _jquery2.default)('#ball-size-wrapper').toggleClass('hidden');
            // HIDE OTHER FORMS
            (0, _jquery2.default)('#ball-size').siblings().children('div').addClass('hidden');
        };
        // BALL SPPEED CHANGE
        // SPEED.onclick = () => {
        //     // TOGGLE FORM
...
var Ball = function () {
  ...
  _createClass(Ball, [{
    ...
    value: function paddleCollision(player1, player2) {
      ...
      // check right side
      if (this.vx > 0) {
        // direction greater than 0 = moving towards right
        ...
        var _paddle = _slicedToArray(paddle, 4),
            ...
            rightX = _paddle[1],
            topY = _paddle[2],
            bottomY = _paddle[3]; // de-structure from array returned by paddle coordinates
...
var Board = function () {
    ...
    _createClass(Board, [{
        ...
        value: function render(svg) {
            ...
            // create line element
            var boardDivider = document.createElementNS(_settings.SVG_NS, 'line');
...
// module
exports.push([module.i, "/* ------- GENERAL SETTINGS ------- */\n\n#game-wrapper {\n    \n}\n\n#settings-wrapper {\n    width: 100%;\n    display: flex;\n    justify-content: center;\n    flex-flow: column nowrap;\n    text-align: center;\n    margin: 0 auto;\n}\n\n#settings-list {\n\n}\n\n#settings-list li {\n    display: inline-block;\n}\n\n#settings-list li ul li{\n    display: block;\n}\n\n/* ------- GAME SETTINGS ------- */\n#game {\n    display: flex;\n    justify-content: center;\n}\n\n/* ------- BALL SETTINGS ------- */\n\n#ball {\n    cursor: pointer;\n    width: 100%;\n}\n\n#ball-list li:nth-child(1), #ball-list li:nth-child(2) {\n    border: solid black 1px;\n}\n\n#ball-list li:nth-child(2) {\n    border-top: none;\n}\n\n#ball-container {\n    background: rgba(0, 0, 0, 0.6);\n}\n\n.ball-wrapper--padding {\n    padding: 0.5rem 0;\n}\n\n.ball-wrapper--margin {\n    margin: 0.5rem 0;\n}\n\n.silver-bg {\n    background: silver;\n}\n\n.ball-form {\n    display: flex;\n    flex-flow: column nowrap;\n}\n\n.hidden {\n    display: none;\n}\n\n", ""]);
